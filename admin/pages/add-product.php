...
if (isset($_POST['add_product'])) {
    ...
    if (empty($product_name) || empty($category_id)) {
        ...
        if (!empty($sku)) {
            $check_sql = "SELECT product_id FROM products WHERE sku = ?";
        ...
        <div class="main-content">
            <div class="content-area">
                <div class="page-header">
                    ...
                    <p>Create a new product with detailed information</p>
                </div>
                ...
                <div class="form-container">
                        ...
                        <div class="info-section">
                            ...
                            <div class="form-grid">
                                <div class="form-group">
                                    ...
                                    <select id="manufacturer_id" name="manufacturer_id">
                                        ...
                                        while ($mfg = $mfg_result->fetch_assoc()) {
                                            echo '<option value="' . $mfg['manufacturer_id'] . '">' . htmlspecialchars($mfg['manufacturer_name']) . '</option>';
                                        }
                                        ?>
                                    </select>
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="text" id="brand" name="brand" value="REDY-MED">
                                </div>
                            </div>
                            ...
                            <div class="form-grid">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="spu" name="spu" placeholder="e.g., SPU-001">
                                </div>
                            </div>
                            ...
                            <div class="form-grid">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="warranty_period" name="warranty_period" placeholder="e.g., 2 years">
                                </div>
                            </div>
                            ...
                            <div class="form-grid full">
                                <div class="form-group">
                                    ...
                                    <textarea id="short_description" name="short_description" placeholder="Brief product description" rows="4"></textarea>
                                </div>
                            </div>
                    ...
                    <div id="specifications-tab" class="tab-content">
                        ...
                        <p style="color: #666; margin-bottom: 1.5rem;">Add technical specifications for this product</p>

                        <div id="specifications-container">
                            <p style="color: #999; text-align: center; padding: 2rem;">
                                <i class="fas fa-info-circle"></i> Select a category first to see available specifications
                            </p>
                        </div>
                    </div>
                    ...
                    <div id="compatibility-tab" class="tab-content">
                        ...
                        <div class="checkbox-group">
                            ...
                            foreach ($compatibility_models_list as $model) {
                                ...
                                echo '<input type="checkbox" id="model_' . $model['model_id'] . '" name="compatibility_models[]" value="' . $model['model_id'] . '">';
                    ...
                    <div id="certifications-tab" class="tab-content">
                        ...
                        <div class="checkbox-group">
                            ...
                            foreach ($certifications_list as $cert) {
                                echo '<div class="checkbox-item">';
                                echo '<input type="checkbox" id="cert_' . $cert['certification_id'] . '" name="certifications[]" value="' . $cert['certification_id'] . '">';
